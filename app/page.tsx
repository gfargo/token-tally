      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl relative">
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold mb-4">
            <span className="sr-only">TokenTally:</span> An All-in-One AI Cost
            Calculator
          </h1>
          <p className="text-xl text-muted-foreground mb-6">
            Estimate costs for various AI models and make informed decisions for
            your projects.
          </p>
...
function CalculatorCard({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`border rounded-lg p-6 h-full hover:shadow-md transition-all duration-200 hover:border-primary/50 flex flex-col ${
            isSpecial ? "bg-gradient-to-br from-primary/10 to-secondary/10" : ""
          }`}
        >
          <div className="flex items-center justify-between mb-4">
            <div
              className={`rounded-full p-2 ${
                isSpecial ? "bg-primary/20" : "bg-primary/10"
              }`}
            >
              {icon}
            </div>
